setwd("~/Sridhar_CDrive/Desktop/Desktop_20150323/Batch 30/CSE 7302c/Day04")

# 1000 Genomes Single Chromosome PCA Example
# Courtesy https://bwlewis.github.io/1000_genomes_examples/PCA.html

library(Matrix)
p = pipe("gzcat ALL.chr20.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz  | sed /^#/d  | cut  -f '10-' | ./a.out | cut -f '1-2'")
...
ids = readLines(pipe("gzcat ALL.chr20.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz  | sed -n /^#CHROM/p | tr '\t' '\n' | tail -n +10"))
...
scatterplot3js(p$u, col=rainbow(N)[ped$Superpopulation], size=0.75)
